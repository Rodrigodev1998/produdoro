...
export function Settings() {
  ...
  return (
    <FocusLock>
      ...
      >
        <S.Header>
          <h2 id="settings-modal-label">Configuração</h2>
        ...
        <S.SettingsForm onSubmit={handleSubmit(onSubmit)}>
          ...
          <Setting title="Sound">
            <S.SettingContainer>
              <label htmlFor="settings-sound-alarmSound">Som do Alarme</label>
              <S.Row>
                <Select
                  control={control}
          ...
          <Setting title="Theme">
            <S.SettingContainer>
              <label htmlFor="settings-theme-colorThemes">Cor Tema</label>
              <ColorSwitcher />
            </S.SettingContainer>
            <S.SettingContainer>
              <label htmlFor="settings-theme-hourFormat">Formato do Horario</label>
              <Select
                control={control}
